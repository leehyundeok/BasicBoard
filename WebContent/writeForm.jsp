...
<form method="post" action="writerPro.do" enctype="multipart/form-data">
...
<table>
   ...
   <tr>
    <td  width="70"  bgcolor="<%=value_c%>" align="center">아이디(닉네임)</td>
    <td  width="330" align="left">
       <input type="text" size="10" maxlength="10" 
          name="writer" style="ime-mode:active;"
          value="<%=id%>"></td><!--active:한글-->
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td  width="330" align="left">
     <input type="password" size="8" maxlength="12" 
             value="<%=password%>" name="password" style="ime-mode:inactive;"></td>
  </tr>
  <tr>      
